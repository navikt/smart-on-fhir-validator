 ...
 * (e.g. "SMART App Launch 2.2 §Scope Equivalence") so a reader can cross-check the claim against
 * spec text without guessing which authority a link belongs to.
 *
 * Opens in the same tab (`rel="noopener"`, no `target`): this app renders inside an EHR vendor's
 * iframe, where `target="_blank"` would break out of the vendor's own navigation.
 */
